...
public class MainActivity extends AppCompatActivity {
    ...
    final ActivityResultLauncher<Intent> startPhoneListActivity = registerForActivityResult(
            new ActivityResultContracts.StartActivityForResult(),
            result -> {
                if (result.getResultCode() == Activity.RESULT_OK && result.getData() != null) {
                    String phoneNumber = result.getData().getStringExtra("selectedPhoneNumber");
    ...
    final ActivityResultLauncher<String> phonePermission = registerForActivityResult(
            ...
            (Boolean permitted) -> {
                if (permitted) {
                    ...
                    //1 вариант лучше использовать!  2й deprecated
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //startPhoneListActivity
        binding.phoneListButton.setOnClickListener(v -> {
            Intent intent = new Intent(MainActivity.this, PhoneListActivity.class);
            startPhoneListActivity.launch(intent);
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE && resultCode == RESULT_OK) {
            String phoneNumber = data.getStringExtra("selectedPhoneNumber");
